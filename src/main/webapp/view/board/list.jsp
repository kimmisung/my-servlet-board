...
<%@ page import="com.kitri.myservletboard.controller.data.Board" %>
    ...
    <div class="p-2 border-primary mb-3">
        <table class="table align-middle table-hover">
            ...
            <tr>
                ...
                <td><a href="/board/detail?id=<%=board.getId()%>"><%=board.getTitle()%></a>
                </td>
                <td><%=board.getWriter()%>
                </td>
                <td><%=board.getCreatedAt().format(DateTimeFormatter.ofPattern("YYYY-MM-DD"))%>
                </td>
