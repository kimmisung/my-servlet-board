        ...
        <div class="input-form col-md-12 mx-auto">
            ...
            <form class="validation-form" novalidate action="/board/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="title" type="title" class="form-control" id="title" placeholder="제목을 입력해주세요" required>
                ...
                <div class="row">
                    <%
                        ...
                        if (member != null) {%>
                    <input id="member_id" name="member_id" value="${member.getId()}" hidden="hidden" />
                    <%}%>

                    <div class="col-md-6 mb-3">
                        <label for="name">작성자</label>
                        <input name="writer" type="text" class="form-control" id="name" placeholder="" value="${member.getName()}" readonly>
                        <div class="invalid-feedback">
                        </div>
                    </div>
                </div>
